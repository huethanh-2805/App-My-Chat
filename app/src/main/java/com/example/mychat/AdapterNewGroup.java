...
public class AdapterNewGroup extends ArrayAdapter<User> implements Filterable {
    Context context;
    ...
    public AdapterNewGroup(Context context, int layoutToBeInflated, List<User> user) {
